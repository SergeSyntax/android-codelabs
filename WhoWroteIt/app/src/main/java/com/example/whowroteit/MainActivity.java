...
public class MainActivity extends AppCompatActivity
    ...
    private static final int LOADER_KEY = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (LoaderManager.getInstance(this).getLoader(LOADER_KEY) != null) {
            LoaderManager.getInstance(this).initLoader(LOADER_KEY, null, this);
        }
    }
    ...
    public void searchBooks(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()
            ...
            LoaderManager.getInstance(this).restartLoader(LOADER_KEY, queryBundle, this);
